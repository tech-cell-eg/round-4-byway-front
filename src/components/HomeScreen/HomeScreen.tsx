...
import homeBanner from "../../assets/homepage-banner-1.png";
...
const HomeScreen: React.FC = () => {
  ...
  return (
    <>
      <div className="mx-auto w-full max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center gap-8 md:flex-row md:justify-between">
          <div className="flex flex-col space-y-6 md:w-1/2">
            ...
            <button className="w-fit rounded-lg bg-blue-600 px-6 py-3 text-white transition-colors hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
      ...
      {/* Status */}
      <div className="w-full bg-gray-100 px-6 py-8 md:px-10 lg:px-20 lg:py-10 flex flex-col lg:flex-row justify-between items-center gap-6">
        {stats.map((item, index) => (
          <div key={index} className="flex items-center lg:flex-row flex-col">
        ...
        {instructors.map((instructor, index) => (
          ...
          >
            <div className="flex flex-col space-y-6 md:w-1/2">
              ...
              <button className="flex items-center gap-3 w-fit rounded-lg bg-gray-900 px-6 py-3 text-white transition-colors hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
